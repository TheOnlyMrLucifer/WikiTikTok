...
def tools_handler(update, context):
    update.message.reply_text('Powerd By @TheOnlyMrLucifer\n\nAka\n\n👻WikiLeaks✌️',parse_mode=_ParseMode)    
# ◇─────────────────────────────────────────────────────────────────────────────────────◇
...
def Download_Video(Link,update, context):
    ...
    try:
       ...
       print('Download Links Generated \n\n\n'+str(req)+'\n\n\n')
        ...
        status_msg.edit_text('⁉️ TikTok Downloader API Error !!! Report To Developer : @TheOnlyMrLucifer')
        status_sticker.delete()
        return
    
    caption_text="""◇───────────────◇
✅ Successfully Downloaded {} Video 🔰
🔰 Powerd by : [🏖 TikTok Download Bot 🏖](https://github.com/TheOnlyMrLucifer/WikiTikTok/)
[👻WikiLeaks✌️ ](https://t.me/TheOnlyMrLucifer)
◇───────────────◇"""
...
# Example For https://github.com/TheOnlyMrLucifer/WikiTikTok

# https://t.me/TheOnlyMrLucifer
